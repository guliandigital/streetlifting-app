/**
 * Passport / cabinet wire DTOs. Shared by the profile feature (self-service)
 * and the federations feature (review panel), so they live in `lib/` rather
 * than in either feature (ADR-0003).
 */
