        ...
        const athlete = await audit.withAudit(
          {
            ...
            before: null,
            after: { lastName: data.lastName, firstName: data.firstName, dateOfBirth: data.dateOfBirth },
          },
          (tx) =>
            tx.athlete.create({
              data: {
                ...
                ...(data.federationCardNumber !== undefined && { federationCardNumber: data.federationCardNumber }),
              },
            }),
        );
