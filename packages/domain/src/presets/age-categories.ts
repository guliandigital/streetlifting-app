 ...
 * v5.1 §10.9.4. Older imported datasets encoded the pre-v5.1 single 60+
...
export const ISF_V51_AGE_CATEGORIES: ReadonlyArray<AgeCategoryPreset> = [
  ...
  // CORRECT vs older imported datasets with a single 60+ band:
  {
    code: 'masters_m5',
    labelEn: 'Masters M5',
    labelRu: 'Masters M5',
  ...
  // CORRECT: M6 is 70+ and open-ended.
  {
    code: 'masters_m6',
    labelEn: 'Masters M6',
    labelRu: 'Masters M6',
 ...
 * single largest user-visible correctness differentiator vs older imported
 * coefficient tables.
 */
