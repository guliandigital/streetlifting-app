...
export const ISF_V51_DISCIPLINES: ReadonlyArray<DisciplinePreset> = [
  ...
  {
    code: 'classic_total',
    labelRu: 'Классический стритлифтинг (total)',
    labelEn: 'Classic Streetlifting (total)',
  ...
  {
    code: 'multirep_total_8_12',
    labelRu: 'Многоповторный стритлифтинг 8/12 (total)',
    labelEn: 'Multirep Streetlifting 8/12 (total)',
  ...
  {
    code: 'multirep_total_8_16',
    labelRu: 'Многоповторный стритлифтинг 8/16 (total)',
    labelEn: 'Multirep Streetlifting 8/16 (total)',
    competitionFormat: 'multirep',
    event: 'PUDI',
    formula: 'result_x_coefficient',
  ...
  {
    code: 'multirep_total_12_16',
    labelRu: 'Многоповторный стритлифтинг 12/16 (total)',
    labelEn: 'Multirep Streetlifting 12/16 (total)',
    competitionFormat: 'multirep',
    event: 'PUDI',
    formula: 'result_x_coefficient',
  ...
  {
    code: 'multirep_total_16_24',
    labelRu: 'Многоповторный стритлифтинг 16/24 (total)',
    labelEn: 'Multirep Streetlifting 16/24 (total)',
    competitionFormat: 'multirep',
    event: 'PUDI',
    formula: 'result_x_coefficient',
  ...
  {
    code: 'multirep_total_24_32',
    labelRu: 'Многоповторный стритлифтинг 24/32 (total)',
    labelEn: 'Multirep Streetlifting 24/32 (total)',
    competitionFormat: 'multirep',
    event: 'PUDI',
    formula: 'result_x_coefficient',
  ...
  {
    code: 'multirep_total_32_48',
    labelRu: 'Многоповторный стритлифтинг 32/48 (total)',
    labelEn: 'Multirep Streetlifting 32/48 (total)',
    competitionFormat: 'multirep',
    event: 'PUDI',
    formula: 'result_x_coefficient',
  ...
  {
    code: 'wc_pu',
    labelRu: 'WC: подтягивания',
    labelEn: 'WC: Pull-Up',
    family: 'weighted_calisthenics',
    competitionFormat: 'classic',
    event: 'PU',
    formula: 'isf_points',
  },
  {
    code: 'wc_di',
    labelRu: 'WC: отжимания на брусьях',
    labelEn: 'WC: Dip',
    family: 'weighted_calisthenics',
    competitionFormat: 'classic',
    event: 'DI',
  ...
  {
    code: 'wc_mu_bar',
    labelRu: 'WC: выход силой на перекладине',
    labelEn: 'WC: Bar Muscle-Up',
    family: 'weighted_calisthenics',
    competitionFormat: 'classic',
    event: 'MU_BAR',
    formula: 'isf_points',
  ...
  {
    code: 'wc_mu_ring',
    labelRu: 'WC: выход силой на кольцах',
    labelEn: 'WC: Ring Muscle-Up',
    family: 'weighted_calisthenics',
    competitionFormat: 'classic',
    event: 'MU_RING',
    formula: 'isf_points',
  ...
  {
    code: 'wc_squat',
    labelRu: 'WC: приседания со штангой',
    labelEn: 'WC: Barbell Squat',
    family: 'weighted_calisthenics',
    competitionFormat: 'classic',
    event: 'SQ',
    formula: 'isf_points',
  ...
  {
    code: 'wc_total',
    labelRu: 'WC: четырёхборье (total)',
    labelEn: 'WC: Four-Event (total)',
    family: 'weighted_calisthenics',
    competitionFormat: 'classic',
    event: 'PUDIMUSQ',
    formula: 'isf_points',
