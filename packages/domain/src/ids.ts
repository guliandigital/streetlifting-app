...
export const OfficialProfileId = idLike.brand<'OfficialProfileId'>();
export const OfficialCredentialId = idLike.brand<'OfficialCredentialId'>();
export const SportRankAwardId = idLike.brand<'SportRankAwardId'>();
export const CompetitionTeamMemberId = idLike.brand<'CompetitionTeamMemberId'>();
...
export type OfficialProfileId = z.infer<typeof OfficialProfileId>;
export type OfficialCredentialId = z.infer<typeof OfficialCredentialId>;
export type SportRankAwardId = z.infer<typeof SportRankAwardId>;
export type CompetitionTeamMemberId = z.infer<typeof CompetitionTeamMemberId>;
